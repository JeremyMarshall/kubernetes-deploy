  ...
  class DeployTask
    ...
    def run!(verify_result: true, allow_protected_ns: false, prune: true)
      ...
      StatsD.event("Deployment of #{@namespace} succeeded",
        ...
        alert_type: "success", tags: statsd_tags << "status:success", prefix: "KubernetesDeploy")
      StatsD.measure('all_resources.duration', StatsD.duration(start), tags: statsd_tags << "status:success", prefix: "KubernetesDeploy")
      ...
      StatsD.measure('all_resources.duration', StatsD.duration(start), tags: statsd_tags << "status:timeout", prefix: "KubernetesDeploy")
      raise
      ...
      StatsD.measure('all_resources.duration', StatsD.duration(start), tags: statsd_tags << "status:failed", prefix: "KubernetesDeploy")
      raise
    end
